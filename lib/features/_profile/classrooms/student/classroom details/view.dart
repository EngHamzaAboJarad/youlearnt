...
class StudentClassroomDetails extends StatefulWidget {
  const StudentClassroomDetails({Key? key, required this.item})
      : super(key: key);

  @override
  State<StudentClassroomDetails> createState() =>
...
class _StudentClassroomDetailsState extends State<StudentClassroomDetails> {
  ...
  void initState() {
    ...
    // });
    Get.find<ClassroomsLogic>().getStudentClassroomDetails(widget.item.id);
  }
