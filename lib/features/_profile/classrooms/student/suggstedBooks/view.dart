...
class StudentSuggstedBooksDetails extends StatefulWidget {
  const StudentSuggstedBooksDetails({
    Key? key,
    required this.suggetsBookModel,
  }) : super(key: key);

  @override
  State<StudentSuggstedBooksDetails> createState() =>
      _StudentSuggstedBooksDetailsState();
  final SuggetsBookModel? suggetsBookModel;
}

class _StudentSuggstedBooksDetailsState
    extends State<StudentSuggstedBooksDetails> {
  ...
  void initState() {
    ...
    Get.find<ClassroomsLogic>()
        .getStudentPrivateSuggestDetails(widget.suggetsBookModel!.id);
  }
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: CustomButtonWidget(
                                                      ...
                                                      loading: logic
                                                          .isUpdatingReschdule,
                                                      onTap: () {
                                                        logic.updateStudentSuggstedBookStatus(
                                                            widget
                                                                .suggetsBookModel!
                                                                .id,
                                                            "approved");
                                                  ...
                                                  child: CustomButtonWidget(
                                                      ...
                                                      onTap: () {
                                                        _helperMethods
                                                            .showAlertDilog(
                                                                message:
                                                                    "Are you sure to reject the new Suggest?",
                                                                title:
                                                                    "Alert!".tr,
                                                                context:
                                                                    context,
