...
import '../../logic.dart';
import '../privateSuggestDetails/view.dart';

class SuggetsTeacherBooksPage extends StatelessWidget {
  SuggetsTeacherBooksPage({Key? key}) : super(key: key);
